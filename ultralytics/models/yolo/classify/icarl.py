...
class ICaRLClassificationTrainer(ClassificationTrainer):
    ...
    This trainer implements the iCaRL algorithm for incremental learning in classification tasks.
    It maintains an exemplar set for previous classes and uses nearest-mean-of-exemplars classification.
    """
    ...
    def setup_model(self):
        ...
        if isinstance(self.model, ClassificationModel):
            ...
            self.feature_extractor = self.model.feature_extractor if hasattr(self.model, 'feature_extractor') else self.model
